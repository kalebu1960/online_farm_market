from sqlalchemy import Column, Integer, String, Float, DateTime, ForeignKey, Enum, Text, Numeric, Boolean, create_engine
...
def main():
    ...
    user_id = User.create(db, email="caleb@example.com", full_name="Caleb", phone_number="1234567890")
